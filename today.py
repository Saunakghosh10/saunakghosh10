...
USER_NAME = os.environ.get('USER_NAME', 'Saunakghosh10')
...
def add_archive():
    """
    If there is archived data from deleted repos, it can be loaded here.
    """
...
if __name__ == '__main__':
    ...
    # Change birthday here to your actual birthday (YYYY, M, D)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2002, 10, 15))
    ...
    if USER_NAME == 'Andrew6rant': # only calculate for user Andrew6rant
